...
const DOM = {
    ...
    async getData() {
        const respuestaCampos = await fetch('http://74.208.94.23:8082/api/v1/campo/get', {
            method: 'POST',
            headers: {
    ...
    async loadData() {
        const respuestaModulos = await fetch('http://74.208.94.23:8082/api/v1/modulo');
...
const comboCarpeta = async () => {
    const respuesta = await fetch('http://74.208.94.23:8082/api/v1/carpeta/get');
...
<!--                    <td></td>-->
    ...
    document.getElementById('btnGuardar').addEventListener('click', async () => {
        ...
        const respuesta = await fetch('http://74.208.94.23:8082/api/v1/campo', {
            method: 'POST',
...
const eliminarFila = async (row, data, index) => {
    if (creating === true) {
        ...
        const respuesta = await fetch('http://74.208.94.23:8082/api/v1/campo/' + data["id_campo"], {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            }
